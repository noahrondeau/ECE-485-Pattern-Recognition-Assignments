...
fprintf('Data set 1: mean = [5, 5]^T, N = 1000, rho = %d\n\n', rho1);
%calculate covariance matrix
SIGMA1 = Q2_CovFrom(sigma1, sigma2, rho1);
...
hold on;
title('Data-Set 1: \mu = [5, 5]^T, N = 1000, \rho = -0.8');
xlabel('x_1');
ylabel('x_2');
ax = gca;
ax.XLim = [x1(1) x1(end)];
...
% fprintf('Data set 2: mean = [5, 5]^T, N = 1000, rho = %d\n\n', rho2);
% SIGMA2 = Q2_CovFrom(sigma1, sigma2, rho2);
% Data2 = Q2_RandomGenerate(N, mu, SIGMA1);
% figure(2);
% scatter(Data2(:,1), Data2(:,2));
% title('Data-Set 2: \mu = [5, 5]^T, N = 1000, \rho = 0.2');
% xlabel('x_1');
% ylabel('x_2');